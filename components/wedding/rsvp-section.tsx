...
export function RSVPSection() {
  ...
  const shreyasNumber = "918884840687"
  const sudhanviNumber = "919449342746"

  const message = encodeURIComponent(
    "Hello! I would like to RSVP for the wedding of Shreyas A & Sudhanvi S."
  )

  const shreyasUrl = `https://wa.me/${shreyasNumber}?text=${message}`
  const sudhanviUrl = `https://wa.me/${sudhanviNumber}?text=${message}`
